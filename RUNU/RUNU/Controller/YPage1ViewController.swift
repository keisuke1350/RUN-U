...
class YPage1ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
...
//        cell.detailTextLabel!.text = self.publishedAtArray[indexPath.row]
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyD8pwXbd_ZYSF47_-A28TaK6iEwhOy6GaQ&q=ランニング&part=snippet&maxResults=2&order=date"
